...
ClapTrap::ClapTrap(string name, unsigned int hitPoints, unsigned int energyPoints, unsigned int attackDamage, unsigned int maxHitPoints) : _name(name), _hitPoints(hitPoints), _energyPoints(energyPoints), _attackDamage(attackDamage), _maxHitPoints(maxHitPoints)
{
    cout << "ClapTrap constructor called" << "\n";
}
